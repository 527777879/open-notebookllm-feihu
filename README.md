...
完整的 7 單元教學簡報，涵蓋概念介紹、技術架構、環境設定、功能使用到部署操作。

👉 **[點此開啟教學簡報](https://chatgpt3a01.github.io/open-notebookllm/簡報/index.html)**

| 單元 | 主題 | 內容 |
|------|------|------|
| Part 1 | 專案概覽與核心功能 | 什麼是 NotebookLLM、功能特色、技術棧 |
| Part 2 | 技術架構與 AI 提供商 | 系統架構、Provider 抽象設計、RAG 原理 |
| Part 3 | 環境設定與安裝 | 環境需求、安裝步驟、API Key 設定 |
| Part 4 | 來源管理與 RAG 搜尋 | 來源類型、RAG 處理流程、搜尋模式 |
| Part 5 | 工作室功能詳解 | 學習卡、測驗、圖表、流程圖、簡報 |
| Part 6 | Podcast 與語音合成 | 腳本生成、TTS 語音引擎、Edge TTS |
| Part 7 | 部署與實戰操作 | 本地部署、Docker、雲端部署、實戰操作 |

> 💡 **提示**：簡報支援鍵盤左右鍵切換頁面，也可以全螢幕播放。
